                        ...
                        <table id="tbl_config_detail" celspacing=0 celpadding=0 class="table_custom">
                          ...
                          {if $productList}
                            {foreach from=$productList item=items}
                              ...
                              <td>
                                <span style="background-color: rgb(239, 191, 128);    margin-bottom: 4px;" class="btn btn-sm btn-view"
                                  onclick="removeRow($(this))">Xóa dòng</span>
                              </td>
                            </tr>
                            {/foreach}
                            {else}
                  ...
                  <div class="form-group row">
                    ...
                    <div class="row pt-2 pt-sm-5 mt-1">
                      <div class="col-sm-6 pl-0">
                        <p class="text-right">
                          <button class="btn btn-space btn-primary editIncome" type="button">Lưu</button>
