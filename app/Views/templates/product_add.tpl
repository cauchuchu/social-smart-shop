              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="avatarOver">
                   <img id="imagePreview" src="..\assets\img\product.jpg" title="ấn vào ảnh để đổi ảnh" alt="Ảnh hiển thị">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-9 col-lg-4">
                      <input class="form-control" name="product_name" id="product_name" type="text" placeholder="Nhập tên sản phẩm">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-3 col-lg-2 col-form-label text-right" for="price">Giá bán</label>
                    <div class="col-9 col-lg-4">
                      <input style="width: 100%;" type="text" onkeyup="formatNumber(this)" maxlength="350" class="price form-control" value="" placeholder="Nhập giá bán của sản phẩm">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="row pt-2 pt-sm-5 mt-1">
                    <div class="col-sm-6 pl-0">
                      <p class="text-right">
                        <button class="btn btn-space btn-primary saveproduct" type="button">Lưu</button>
