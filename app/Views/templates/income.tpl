{block name='content'}
    ...
    <div class="be-contents">
        <div class="page-head">
            <h2 class="page-head-title">Danh sách phiếu nhập hàng</h2>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="noSwipe">
                            ...
                            <table class="table table-striped table-hover be-table-responsive" id="tableIncome">
                                <thead>
                                    <tr>
                                        <th style="width:10%;">
                                            Mã phiếu
